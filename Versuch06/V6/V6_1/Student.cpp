 ...
 * @brief Operator for comparing two Students.
 * @param stud Student to compare with.
 * @return True: if matr of the given student is less or equal then the one of stud(param)
 */
bool Student::operator >= (const Student& stud)
{
	if (matNr >= stud.matNr)
 ...
 * @brief Operator for comparing two Students.
 * @param stud Student to compare with.
 * @return True: if matr of the given student is greater or equal then the one of stud(param)
 */
bool Student::operator <= (const Student& stud)
{
	if (matNr <= stud.matNr)
